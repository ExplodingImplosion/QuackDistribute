...
func _ready():
	...
	add_resource("Base Weapon", preload("res://Weapons/Base Weapon.tscn"))
	add_resource("Dropped Weapon", preload("res://Weapons/Dropped Weapon.tscn"))
	
	#add all guns and their dropped counterparts
	
	
	add_resource("M4", preload("res://Weapons/M4/M4.tscn"))
	add_resource("Dropped M4", preload("res://Weapons/M4/Dropped M4.tscn"))
	
	add_resource("1911", preload("res://Weapons/1911/1911.tscn"))
	add_resource("Dropped 1911", get_resource("Dropped Weapon"))
	
	add_resource("AK", preload("res://Weapons/AK/AK.tscn"))
